      ...
      img.onload = () => {
        try {
          if (cropToContent) {
            ...
            // Normalizar alpha: píxeles semi-opacos con color (no blanco/transparente)
            // pasan a 255 para evitar que pines semi-transparentes se vean lavados.
            // Se excluyen píxeles near-white (fondos blancos con alpha bajo).
